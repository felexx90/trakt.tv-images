...
var Omdb = require('react-native-omdbapi');
var fanart = require('react-native-fanart.tv');
var Fanart = false;
...
var getTmdb = function(id) {
  return new Promise(function(resolve) {
    ...
    return axios({
      url: 'https://api.themoviedb.org/3/movie/' + id + '/images?api_key=' +
      TmdbApiKey,
      json: true,
      headers: {
        'content-type': 'application/json'
...
var getTvdb = function(id) {
  return new Promise(function(resolve) {
    ...
    return Promise.all(
      [tvCall('fanart', 'background'), tvCall('poster', 'poster')]).
      then(function(responses) {
        var obj = {};
        obj[Object.keys(responses[0])[0]] = responses[0][Object.keys(
          responses[0])[0]];
        obj[Object.keys(responses[1])[0]] = responses[1][Object.keys(
          responses[1])[0]];
        return resolve({
          source: 'tvdb',
          img: obj
...
var parseItem = function(input) {
  ...
  if (input.ids) {
    if (input.ids.imdb !== undefined &&
      (input.ids.tmdb !== undefined || input.ids.tvdb !== undefined)) {
